                ...
                builder: (context, snap) {
                  ...
                  final patients = docs.map<_Patient>((d) {
                    ...
                    return _Patient(
                      ...
                      phone: (m['ownerPhone'] ?? m['phone'] ?? '').toString(),
                  ...
                  final healthy = patients
                      .where((p) => p.status == 'Saudável')
                      .length;
                  final inTreatment = patients
                      .where((p) => p.status == 'Em Tratamento')
                      .length;
            ...
            GestureDetector(
              onTap: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content:
                    Text('Fluxo de nova consulta em desenvolvimento.'),
                  ),
                );
              },
              child: Container(
...
class _PatientCard extends StatelessWidget {
  ...
  Color _statusText(String s) {
    ...
    return const Color(0xFF4B5563); // cinza
  }
...
class _BottomNavItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = selected ? ClickVetColors.gold : Colors.black54;
