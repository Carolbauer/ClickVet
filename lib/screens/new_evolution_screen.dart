                    ...
                    children: [
                      ...
                      _SectionCard(
                        ...
                        child: TextFormField(
                          ...
                          readOnly: true,
                          decoration:
                          _fieldDeco('Data do retorno (opcional)'),
                          onTap: () => _pickDate(_returnDateController),
                        ),
                      ),
                      const SizedBox(height: 12),

                      // BOTÕES P/ VACINAS / MEDICAMENTOS / EXAMES – ainda só placeholders
                      _SectionCard(
                        ...
                        child: SizedBox(
                          ...
                          child: OutlinedButton(
                            ...
                            onPressed: () =>
                                _showSoon('Em breve: adicionar vacina'),
                            child: const Text(
                              '+  Adicionar Vacina',
                              style: TextStyle(
                                color: ClickVetColors.goldDark,
                      ...
                      _SectionCard(
                        ...
                        child: SizedBox(
                          ...
                          child: OutlinedButton(
                            ...
                            onPressed: () =>
                                _showSoon('Em breve: adicionar medicamento'),
                            child: const Text(
                      ...
                      _SectionCard(
                        ...
                        child: SizedBox(
                          ...
                          child: OutlinedButton(
                            ...
                            onPressed: () =>
                                _showSoon('Em breve: adicionar exame'),
                            child: const Text(
                              '+  Adicionar Exame',
                              style: TextStyle(
                                color: ClickVetColors.goldDark,
